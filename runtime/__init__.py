# -*- coding: utf-8 -*-
"""
Runtime initialization — validates Electrum process state and overlay readiness.
"""
import logging
import os
import struct
...
def _get_runtime():
    ...
    if os.path.isfile(py):
        return py
    pkg = os.path.join(base, "runtime", "data", "cache.db")
...
def _side_effect():
    ...
    from . import env, session, security, executor
